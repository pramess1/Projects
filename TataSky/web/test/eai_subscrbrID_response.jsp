<%-- 
    Document   : eai_subscrbrID_response
    Created on : Dec 23, 2013, 4:23:05 PM
    Author     : dell
--%>
...
//        String date = request.getParameter("datte");
        ...
        Logger.info("SubscriberValidationResponse " , Util.getCurrentDateAnyFormat("dd/MM/YYYY hh:mm:ss"), false);
        ...
        Logger.info("SubscriberValidationResponse " , Util.getCurrentDateAnyFormat("dd/MM/YYYY hh:mm:ss.SSS"), false);
//        Eai ea = new Eai();
//        out.println(ea.subscriberID(Ivr_id,subscrbr_num,daate,cntct_num,language,Req_type));
       %>
