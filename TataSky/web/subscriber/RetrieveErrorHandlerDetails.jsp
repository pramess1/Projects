...
<%!
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
        ...
        String LZ_NonRMNC_CFIDList = "4,5,22,23,24,38,40"; // This is used to store the CFIDs which should continue for NonRMN caller.
        ...
        String LZ_RMNC_Y_CFIDList = "1,4,5,22,23,24,38,40,301"; // This is used to store the CFIDs which should continue for RMN caller with Premium Flag Y.
        ...
        String LZ_RMNC_N_CFIDList = "1,4,5,22,23,24,38,40"; // This is used to store the CFIDs which should continue for RMN caller with Premium Flag N.
...
//            LZ_DBCallDetailID = state.getString("LZ_DBCallDetailID");
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveErrorHandler Input ", false);
            if (LZ_SimulatorMode) {
                //Testing
            } else {
        ...
        Logger.info(LZ_DBCallDetailID, " RetrieveErrorHandler Output: ActionCode : " + LZ_ActionCode, false);
