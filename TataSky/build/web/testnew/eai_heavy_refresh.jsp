<%-- 
    Document   : eai_heavy_refresh
    Created on : Nov 18, 2013, 10:47:57 AM
    Author     : dell
--%>
...
<html>
    <head>
        ...
        <title>Heavy Refresh</title>
    </head>
    <body>
        <form id="eai_heavy_ref" action="eai_heavy_ref_response.jsp" method ="post">
            <center>
            ...
            <table>
                ...
                <tr><td>Request Type </td><td> <input type="text" name="rqust_typ" value="HeavyRefresh" size="22"/> <br/></td></tr>
