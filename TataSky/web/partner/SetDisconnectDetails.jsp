...
//            LZ_DBCallDetailID = state.getString("LZ_DBCallDetailID");
            ...
            Logger.info(LZ_DBCallDetailID, " SetDisconnectDetails Input ", false);
            ...
            if (LZ_SimulatorMode) {
                ...
                Logger.info(LZ_DBCallDetailID, "Set Disconnect Details : Partner Sub Type : " + LZ_PartnerSubType + " Product Type : " + LZ_ProductType
                        + " Actual Customer Class : " + LZ_ActualCustomerClass + " Segment Sub Type :" + LZ_SegmentSubType
                        + " Is Sensitive : " + LZ_IsSensitive, false);


                String LZ_CallerType = XMLAO.getNodeValueText(docBA, "BA_PARTNER_TYPE");
                String LZ_SubscriberIDCount = XMLAO.getNodeValueText(docBA, "BA_SUBSCRIBER_ID_COUNT");
                String LZ_AccountStatus = XMLAO.getNodeValueText(docBA, "BA_PARTNER_ACCOUNT_STATUS");
                ...
                LZ_tempCount--;
                String LZ_tempCFID = XMLAO.getNodeValueText(docBA, "FLDCALLFLOWID", LZ_tempCount);

                System.out.println("LZ_tempCount :" + LZ_tempCount);
                ...
                String LZ_LastTraversedCFDID = XMLAO.getNodeValueText(docBA, "FLDCALLFLOWID", LZ_tempCount);
                ...
                String ctiPartnerCode = XMLAO.getNodeValueText(docBA, "BA_PARTNER_ID");
                ...
                /*String updateTCDResult = new UpdateCallDetailDAO().updateCallDetail(LZ_DBCallDetailID, 
                 ...
                 LZ_PremiumFlag1, "IVR", "", LZ_LastTraversedCFDID, "", "", "", LZ_AccountStatus, LZ_AccountSubStatus, 
                 LZ_SubscriberIDCount, LZ_NonRMNIdentifier, LZ_SubIDValidated, LZ_CLI);*/
                ...
                String updateTCDResult = new UpdateCallDetailDAO().updateCallDetail(LZ_DBCallDetailID,
                        Util.getCurrentDateTime(), LZ_IVRLanguage, ctiPartnerCode, "", LZ_CallerType,
            ...
            Logger.info(LZ_DBCallDetailID, " SetDisconnectDetails output ", false);
            LZ_CallFlowDetailXML = LZ_IVRLanguage = LZ_SubscriberID = LZ_DBCallDetailID =
                    LZ_PartnerSubType = LZ_ProductType = LZ_ActualCustomerClass = LZ_IsSensitive = null;
        }
