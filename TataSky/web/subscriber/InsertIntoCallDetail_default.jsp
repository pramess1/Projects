    ...
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
        ...
        try {
            if (b_SimulatorMode) {
                ...
                LZ_CallTypeID = state.optString("LZ_CallTypeFromAgent","");
               ...
               else
               {
                ...
                Logger.info("", "LZ_SubscriberId : " + LZ_SubscriberId + " LZ_AppID : " + LZ_AppID + "LZ_RMN : " + LZ_RMN
                        + " LZ_AppLanguage : " + LZ_AppLanguage, false);
           ...
           LZ_PrimaryDNIS = LZ_SecondaryDNIS = LZ_DCVAG = LZ_DCVQ = LZ_DirectSalesDNIS = LZ_AgentDNIS = LZ_DNISCode = LZ_UsrANI = LZ_UsrDNIS = LZ_AppID = LZ_UsrCallSessionID = LZ_UsrCallUUID = LZ_CallTypeID =  LZ_Date = null; 
        }
