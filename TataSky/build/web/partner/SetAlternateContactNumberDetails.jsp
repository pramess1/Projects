...
//            LZ_DBCallDetailID = state.getString("LZ_DBCallDetailID");
            ...
            try {
                ...
                LZ_ivrid = BA_SUBSCRIBER_ID = LZ_Phone_No = BA_SELECTED_LANGUAGE = LZ_DateTime = LZ_RequestType = LZ_Sub_Status = LZ_errorMsg = LZ_RequestXML = LZ_ResponseXML = LZ_ServiceID = LZ_TransStartTime = LZ_TransEndTime = null;
            }
        }
