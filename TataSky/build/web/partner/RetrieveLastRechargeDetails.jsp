            ...
            if (LZ_SimulatorMode) {
                ...
                if (!LZ_BALastRechargeAmount.isEmpty()) {
                    ...
                    if (LZ_tempAmount <= 0) {
                        ...
                        if (LZ_tempCount > 1) {
                            sbDCF.append("<Menu CFID=\"103\">9011.wav</Menu><Menu CFID=\"9000\">9046.wav</Menu><Menu CFID=\"107\">9061.wav</Menu><Menu CFID=\"910\">7030.wav</Menu><Menu CFID=\"905\">7013.wav</Menu><Menu CFID=\"904\">7223.wav</Menu><Menu CFID=\"906\">7018.wav</Menu></CallFlow>");
                        } else {
