...
//            LZ_CallFlowDetailXML = state.getString("LZ_CallFlowDetailXML");
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveInstallerVisitScheduleDetails Input ", false);
            if (LZ_SimulatorMode) {
                BA_SUBSCRIBER_ID = "N";
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveInstallerVisitScheduleDetails Output = BA_PREMIUM_FLAG :  " + BA_PREMIUM_FLAG + " BA_SUBSCRIBER_ID : " + BA_SUBSCRIBER_ID + " BA_ACCOUNT_STATUS : " + BA_ACCOUNT_STATUS, false);
