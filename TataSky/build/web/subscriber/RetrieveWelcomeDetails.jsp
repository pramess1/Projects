...
<%!
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
        ...
        String LZ_BACustomGreetFlag = ""; // Custom greeting enable/disable
...
//            LZ_CallFlowDetailXML = state.getString("LZ_CallFlowDetailXML");
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveWelcomeDetails Input ", false);
            if (LZ_SimulatorMode) {
            } else {
                ...
                LZ_BACustomGreetFlag = ConfigurationReader.configList.get("CUSTOM_GREET_FLAG");
            }
        } catch (Exception ex) {
            Logger.error(LZ_DBCallDetailID, " Exception in RetrieveWelcomeDetails Page : " + ex.getMessage(), false);
        } finally {
            Logger.info(LZ_DBCallDetailID, " RetrieveWelcomeDetails Output =  LZ_TimePhase : " + LZ_TimePhase + " LZ_BACallerType " + LZ_BACallerType
                    + " LZ_BABrandGreetFlag : " + LZ_BABrandGreetFlag + " LZ_BASeasonalGreetFlag : " + LZ_BASeasonalGreetFlag + " LZ_BACustomGreetFlag : " + LZ_BACustomGreetFlag, false);
        ...
        result.put("BACustomGreetFlag", LZ_BACustomGreetFlag);
