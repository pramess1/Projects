...
<%!
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
        ...
        String LZ_CallFlowDetailXML = ""; // This is used to 
...
//            LZ_CallFlowDetailXML = state.getString("LZ_CallFlowDetailXML");
            ...
            LZ_DBCallDetailID = XMLAO.getNodeValueText(docBA, "FLDCALLDETAILID");
//            LZ_CurrentLanguage = state.getString("LZ_CurrentLanguage");
            ...
            Logger.info(LZ_DBCallDetailID, " RetrievePreferredLanguageDetails Input = LZ_CurrentLanguage : " + LZ_CurrentLanguage + " LZ_LanguageListArray : " + LZ_LanguageListArray, false);

            for (int i = 0; i < LZ_LanguageListArray.length; i++) {
                if (LZ_CurrentLanguage.equals(LZ_LanguageListArray[i])) {
                    if (LZ_CurrentLanguage.equals("English")) {
                        ...
                        LZ_DynamicCallFlowXML = "<CallFlow CDID=\"" + LZ_DBCallDetailID + "\" RuleID=\"\"><Prompt CFID=\"38\">1037.wav</Prompt><Prompt CFID=\"38\">" + LZ_LanguagePromptListArray[i] + "</Prompt><Prompt CFID=\"38\">1036.wav</Prompt><Menu CFID=\"911\">7225.wav</Menu><Menu CFID=\"909\">7029.wav</Menu><Menu CFID=\"907\">7012.wav</Menu></CallFlow>";
                        break;
                    }
                }
            }
            LZ_LanguageListArray = LZ_LanguagePromptListArray = null;
        } catch (Exception ex) {
            Logger.error(LZ_DBCallDetailID, " Exception in RetrievePreferredLanguageDetails Page : " + ex.getMessage(), false);
        } finally {
            Logger.info(LZ_DBCallDetailID, " RetrievePreferredLanguageDetails Output = LZ_DynamicCallFlowXML : " + LZ_DynamicCallFlowXML, false);
            LZ_DBCallDetailID = LZ_CallFlowDetailXML = LZ_CurrentLanguage = LZ_LanguageList = LZ_LanguagePromptList = null;
        }
