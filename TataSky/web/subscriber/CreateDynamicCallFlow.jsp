...
<%!
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
        ...
        String LZ_RuleDescription = ""; // This is used to store the rule description
...
//            LZ_CallDetailID = state.getString("LZ_DBCallDetailID");
              ...
              Logger.info(LZ_CallDetailID, " CreateDynamicCallFlow Input = LZ_CallFlowType : " + LZ_CallFlowType + " LZ_PromptList : " + LZ_CallFlowIDList + " LZ_RuleID : " + LZ_RuleID + " LZ_RuleDescription : " + LZ_RuleDescription, false);
            if (LZ_SimulatorMode) {
            } else {
                
                StringBuilder sbDCF = new StringBuilder("<CallFlow CDID=\"" + LZ_CallDetailID + "\" RuleID=\"" + LZ_RuleID +  "\" RuleDesc=\"" + LZ_RuleDescription + "\">");
            ...
            Logger.info(LZ_CallDetailID, " CreateDynamicCallFlow Output = LZ_DynamicCallFlowXML : " + LZ_DynamicCallFlowXML, false);
