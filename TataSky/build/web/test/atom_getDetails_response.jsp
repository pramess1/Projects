<%-- 
    Document   : atom_getDetails_response
    Created on : Dec 24, 2013, 7:39:12 AM
    Author     : dell
--%>
...
//        RechargeAtom ra = new RechargeAtom();
//        out.println(ra.atomGetDetails(Ivr_ID,tatasky_txn_id,atm_mrchnt_id,Method_Type,srvc_id,amnt,tata_sbscr_id,cstmr_clr_id,gene_uni_id,User_id,SR_num,Product,DB_call_dtl_id));
//        
