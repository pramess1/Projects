...
//            LZ_CallFlowDetailXML = state.getString("LZ_CallFlowDetailXML");
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveProvisionalPromoDetails Input = CallFlowDetailXML : " + LZ_CallFlowDetailXML, false);
            if (LZ_SimulatorMode) {
            } else {
                ...
                LZ_BAPincode = XMLAO.getNodeValueText(docBA, "BA_RMN");
            ...
            Logger.error(LZ_DBCallDetailID, " Exception in  RetrieveProvisionalPromoDetails Page : " + ex.getMessage(), false);
        } finally {
            Logger.info(LZ_DBCallDetailID, " RetrieveProvisionalPromoDetails Output = LZ_BARMN : " + LZ_BARMN + " LZ_CurrentDate : " + LZ_CurrentDate +  " LZ_BACallerType : " + LZ_BACallerType + " LZ_BAPremiumFlag : " + LZ_BAPremiumFlag + " LZ_BASTBType : " + LZ_BASTBType
                    + " LZ_BAAccountStatus : " + LZ_BAAccountStatus + " LZ_BANationalPromoFlag : " + LZ_BANationalPromoFlag + " LZ_BAState : " + LZ_BAState + " LZ_BAPincode : " + LZ_BAPincode + " LZ_BASPMCampaignFlag : " + LZ_BASPMCampaignFlag
                    + " LZ_BASPMPackName : " + LZ_BASPMPackName + " LZ_BASubscriptionType : " + LZ_BASubscriptionType + " LZ_BAAccountSubStatus : " + LZ_BAAccountSubStatus + " LZ_NUANCE_URL : " + LZ_NUANCE_URL, false);
