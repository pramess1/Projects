...
<%!
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
        ...
        try {
            ...
            if (LZ_CallDetailID.equals("")) {
                LZ_CallDetailID = state.optString("GZ_CallDetailID", "");
            }
            ...
            //LZ_InputValue : ,100 LZ_CallFlowInputStartDateTime : ,2014-9-19 14:53:9.594 LZ_CallFlowInputEndDateTime : ,2014-9-19 14:53:14.928,2014-9-19 14:53:14.928
            ...
            // LZ_CallFlowInputStartDateTime = ",2014-9-19 14:53:9.594";

            // LZ_CallFlowInputEndDateTime = ",2014-9-19 14:53:14.928,2014-9-19 14:53:14.928";
            ...
            Logger.info(LZ_CallDetailID, " RetrieveRechargeCallFlowResult Input = LZ_CallFlowID : " + LZ_CallFlowID + " LZ_NoOfAttempts : " + LZ_NoOfAttempts + " LZ_tempAttempts : " + LZ_tempAttempts
                    + " LZ_RuleID : " + LZ_RuleID + " LZ_RuleDescription : " + LZ_RuleDescription + " LZ_InputValue : " + LZ_InputValue + " LZ_CallFlowInputStartDateTime : " + LZ_CallFlowInputStartDateTime + " LZ_CallFlowInputEndDateTime : " + LZ_CallFlowInputEndDateTime, false);

            /*  System.out.println("LZ_CallDetail ID=" + LZ_CallDetailID);
            ...
            try {
                if (!LZ_CallFlowInputStartDateTime.equals("")) {
                    if (!LZ_CallFlowInputStartDateTime.substring(0, 1).equals(",")) {
                        ...
                        Logger.debug(LZ_CallDetailID, "LZ_CallFlowInputStartDateTime " + LZ_CallFlowInputStartDateTime, false);
                    }
                }
            } catch (Exception e) {

                Logger.error(LZ_CallDetailID, "Exception in LZ_CallFlowInputStartDateTime from RetrieveRechargeCallFlowResult.jsp " + LZ_CallFlowInputStartDateTime, false);
            }
            ...
            try {
                if (!LZ_CallFlowInputEndDateTime.equals("")) {
                    if (!LZ_CallFlowInputEndDateTime.substring(0, 1).equals(",")) {
                        ...
                        Logger.debug(LZ_CallDetailID, "LZ_CallFlowInputEndDateTime " + LZ_CallFlowInputEndDateTime, false);
                    }
                }
            } catch (Exception e) {
                Logger.error(LZ_CallDetailID, "Exception in LZ_CallFlowInputEndDateTime from RetrieveRechargeCallFlowResult.jsp " + LZ_CallFlowInputEndDateTime, false);
            }
            ...
            if (LZ_SimulatorMode) {
                ...
                try {
                    for (int i = 1; i <= Integer.parseInt(LZ_NoOfAttempts); i++) {
                        switch (i) {
                            case 1:
                                Logger.debug(LZ_CallDetailID, "Inside Switch.. case1.. The " + i + " th loop", false);
                                if (!LZ_CallFlowInputStartDateTime.isEmpty()) {
                                    ...
                                    Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_CallFlowFirstInputStartDateTime " + LZ_CallFlowFirstInputStartDateTime, false);
                                }
                                ...
                                if (!LZ_CallFlowInputEndDateTime.isEmpty()) {
                                    ...
                                    Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_CallFlowFirstInputEndDateTime " + LZ_CallFlowFirstInputEndDateTime, false);
                                }

                                if (!LZ_InputValue.isEmpty()) {
                                    if (LZ_tempInputValue[i].isEmpty()) {
                                        LZ_FirstInputID = LZ_NoInputCFID;
                                        Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_FirstInputID " + LZ_FirstInputID, false);
                                    } else if (!LZ_MenuOptionList.contains(LZ_tempInputValue[i])) {
                                        LZ_FirstInputID = LZ_NoMatchCFID;
                                        Logger.debug(LZ_CallDetailID, "Inside else if Statement of Switch... Menu Option List: LZ_FirstInputID " + LZ_FirstInputID, false);
                                    } else {
                                        ...
                                        Logger.debug(LZ_CallDetailID, "Inside else Statement of Switch Menu Option List split : LZ_FirstInputID " + LZ_FirstInputID, false);
                                    }
                                ...
                                break;
                            case 2:
                                Logger.debug(LZ_CallDetailID, "Inside Switch.. case2.. The " + i + " th loop", false);
                                if (!LZ_CallFlowInputStartDateTime.isEmpty()) {
                                    ...
                                    Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_CallFlowSecondInputStartDateTime " + LZ_CallFlowSecondInputStartDateTime, false);
                                ...
                                if (!LZ_CallFlowInputEndDateTime.isEmpty()) {
                                    ...
                                    Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_CallFlowSecondInputEndDateTime " + LZ_CallFlowSecondInputEndDateTime, false);

                                }
                                if (!LZ_InputValue.isEmpty()) {
                                    if (LZ_tempInputValue[i].isEmpty()) {
                                        LZ_SecondInputID = LZ_NoInputCFID;
                                        Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_SecondInputID " + LZ_SecondInputID, false);
                                    } else if (!LZ_MenuOptionList.contains(LZ_tempInputValue[i])) {
                                        LZ_SecondInputID = LZ_NoMatchCFID;
                                        Logger.debug(LZ_CallDetailID, "Inside else if Statement of Switch... Menu Option List: LZ_SecondInputID " + LZ_SecondInputID, false);
                                    } else {
                                        String[] LZ_tempOptionList = LZ_MenuOptionList.split(",");
                                        ...
                                        Logger.debug(LZ_CallDetailID, "Inside else Statement of Switch Menu Option List split : LZ_SecondInputID " + LZ_SecondInputID, false);
                                        LZ_tempOptionList = null;
                                    }
                                ...
                                break;
                            case 3:
                                Logger.debug(LZ_CallDetailID, "Inside Switch.. case3.. The " + i + " th loop", false);
                                if (!LZ_CallFlowInputStartDateTime.isEmpty()) {
                                    ...
                                    Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_CallFlowThirdInputStartDateTime " + LZ_CallFlowThirdInputStartDateTime, false);
                                ...
                                if (!LZ_CallFlowInputEndDateTime.isEmpty()) {
                                    ...
                                    Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_CallFlowThirdInputEndDateTime " + LZ_CallFlowThirdInputEndDateTime, false);
                                }
                                if (!LZ_InputValue.isEmpty()) {
                                    if (LZ_tempInputValue[i].isEmpty()) {
                                        LZ_ThirdInputID = LZ_NoInputCFID;
                                        Logger.debug(LZ_CallDetailID, "Inside if Statement of Switch : LZ_ThirdInputID " + LZ_ThirdInputID, false);
                                    } else if (!LZ_MenuOptionList.contains(LZ_tempInputValue[i])) {
                                        LZ_ThirdInputID = LZ_NoMatchCFID;
                                        Logger.debug(LZ_CallDetailID, "Inside else if Statement of Switch... Menu Option List: LZ_ThirdInputID " + LZ_ThirdInputID, false);
                                    } else {
                                        String[] LZ_tempOptionList = LZ_MenuOptionList.split(",");
                                        ...
                                        Logger.debug(LZ_CallDetailID, "Inside else Statement of Switch Menu Option List split : LZ_ThirdInputID " + LZ_ThirdInputID, false);
                                        LZ_tempOptionList = null;
                                    }
                ...
                LZ_temp = LZ_CallFlowDetailXML.substring(LZ_StartIndex, LZ_EndIndex);
                    ...
                    Logger.error(LZ_CallDetailID, "Exception in Substring...", false);
                }
