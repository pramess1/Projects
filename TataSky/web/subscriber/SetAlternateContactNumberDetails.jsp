...
//            LZ_DBCallDetailID = state.getString("LZ_DBCallDetailID");
            ...
            Logger.info(LZ_DBCallDetailID, " SetPreferredLanguageDetails Input ", false);
            if (LZ_SimulatorMode) {
            } else {
                ...
                LZ_Phone_No = XMLAO.getNodeValueText(docBA, "FLDCLI");
                BA_SELECTED_LANGUAGE = XMLAO.getNodeValueText(docBA, "BA_SELECTED_LANGUAGE");
            ...
            Logger.error(LZ_DBCallDetailID, " Exception in SetAlternateContactNumberDetails Page : " + ex.getMessage(), false);
        } finally {
            try {
                ...
                LZ_ivrid = BA_SUBSCRIBER_ID = LZ_Phone_No = BA_SELECTED_LANGUAGE = LZ_DateTime = LZ_RequestType = LZ_Sub_Status =
                        LZ_errorMsg = LZ_RequestXML = LZ_ResponseXML = LZ_ServiceID = LZ_TransStartTime = LZ_TransEndTime = null;
            }
        }
        ...
        Logger.info(LZ_DBCallDetailID, "SetPreferredLanguageDetails Output = LZ_Status : " + LZ_Status
