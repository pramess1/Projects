...
//            LZ_CallFlowDetailXML = state.getString("LZ_CallFlowDetailXML");
            ...
            if (LZ_SimulatorMode) {
                ...
                Logger.info(LZ_DBCallDetailID, " RetrieveInsidePremisesDetails Input = LZ_BASelectedLanguage : " + LZ_BASelectedLanguage, false);
            ...
            Logger.error(LZ_DBCallDetailID, " Exception in RetrieveInsidePremisesDetails Page : " + ex.getMessage(), false);
        } finally {
            Logger.info(LZ_DBCallDetailID, " RetrieveInsidePremisesDetails Output = LZ_BASelectedLanguage : " + LZ_BASelectedLanguage + " LZ_BASubscriberID :  " + LZ_BASubscriberID, false);
