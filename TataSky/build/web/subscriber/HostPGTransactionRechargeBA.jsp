<%@page import="com.tsg.encryption.Encryption"%>
...
//                LZ_spUpdateAuthorizeTxn = state.getString("LZ_spUpdateAuthorizeTxn");
                ...
                LZ_IVRTxnID = LZ_CallFlowDetailXML.substring(LZ_CallFlowDetailXML.lastIndexOf("<FLDATOMUNIQUEID>") + 17, LZ_CallFlowDetailXML.lastIndexOf("</FLDATOMUNIQUEID>"));

                LZ_Product = state.optString("LZ_Product", "");

                if (LZ_Product.equals("DirectSales")) {

                    BA_SUBSCRIBER_ID = LZ_CallFlowDetailXML.substring(LZ_CallFlowDetailXML.lastIndexOf("<SRNumber>") + 10, LZ_CallFlowDetailXML.lastIndexOf("</SRNumber>"));

                    BA_SUBSCRIBER_ID = BA_SUBSCRIBER_ID.replaceAll("-", "");

                    LZ_GetAmount = LZ_CallFlowDetailXML.substring(LZ_CallFlowDetailXML.lastIndexOf("<FLDSRPRICEPOINT>") + 17, LZ_CallFlowDetailXML.lastIndexOf("</FLDSRPRICEPOINT>"));
...
//               + " LZ_spUpdateAuthorizeTxn : " + LZ_spUpdateAuthorizeTxn + " LZ_DBCallDetailID : " + LZ_DBCallDetailID, false);
                ...
                LZ_AtomUniqueId = LZ_CallFlowDetailXML.substring(LZ_CallFlowDetailXML.lastIndexOf("<FLDATOMUNIQUEID>") + 17, LZ_CallFlowDetailXML.lastIndexOf("</FLDATOMUNIQUEID>"));
                ...
                TransactionRechargeResponse objDataService = new TransactionRecharge1().requestTransactionRecharge(LZ_AtomMerchantID,
                        ...
                        LZ_EMITenure, LZ_MobileNo, LZ_BAPin, objEncrypt.encrypt(LZ_CardNumber), LZ_PaymentType, LZ_TSTxnID, LZ_AtomUniqueId, LZ_DBCallDetailID);
            ...
            try {
                ...
                if (LZ_CardNumber.length() == 16) {
                    LZ_CardNumber = maskCardNumber.maskCardNumber(LZ_CardNumber, "######xxxxxx####");
                } else if (LZ_CardNumber.length() == 15) {
                    LZ_CardNumber = maskCardNumber.maskCardNumber(LZ_CardNumber, "######xxxxx####");
                }
