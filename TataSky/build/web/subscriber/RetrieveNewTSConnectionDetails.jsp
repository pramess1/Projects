...
//            LZ_DBCallDetailID = state.getString("LZ_DBCallDetailID");
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveNewTSConnectionDetails Input = CallFlowDetailXML : " + LZ_CallFlowDetailXML, false);
            if (LZ_SimulatorMode) {
            } else {
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveNewTSConnectionDetails Output = LZ_BARepeatCallerFlag : " + LZ_BARepeatCallerFlag + " LZ_RoutePoint : " + LZ_RoutePoint, false);
