...
//		LZ_CallFlowDetailXML = state.getString("LZ_CallFlowDetailXML");
                ...
                {
                        if(LZ_LanguageArray[i].equals(LZ_CurrentLanguage))
                        {
                ...
                if(!LZ_IsCorrectLanguage)
                {
                        ...
                        else
                        {
                                ...
                                if(LZ_BACallerType.equals("RMN") && (LZ_BAPrimary_Language.isEmpty() && LZ_BASecondary_Language.isEmpty()))
                                {
                                        ...
                                        if(LZ_LanguageAlertStartIndex > 0)
                                        {
                                                ...
                                                {
                                                        LZ_CallFlowDetailXML = LZ_CallFlowDetailXML.replace(LZ_tempLanguageAlert, "<CTILANGUAGEALERT>Preferred Language is incorrect in database, please update in Siebel</CTILANGUAGEALERT>");
                                                }
                                        }
                                        else
                                        {
                        ...
                        if(!LZ_AppLanguage.equals(LZ_tempAppLanguage))
                        {
                        ...
                        if(LZ_CurrentLanguage.equals("Manipuri"))
                        {
           ...
           Logger.error("", " Exception in RetrieveLanguageDetails Page : " + ex.getMessage(), false);
             ...
             LZ_BAPrimary_Language = LZ_BASecondary_Language = LZ_BADefault_Language = LZ_BASelected_Language = LZ_AppLanguageList = LZ_LanguageList = LZ_BACallerType = null;
