...
//            LZ_MenuOptionSelected = state.getString("LZ_MenuOptionSelected");
                ...
                if (!LZ_MenuOptionSelected.equals("#")) {
                    ...
                    for (int i = 0; i < LZ_LanguageCallIDListArray.length; i++) {
                        if (LZ_tempID.equals(LZ_LanguageCallIDListArray[i])) {
                            ...
                            int LZ_EndIndex = LZ_CallFlowDetailXML.indexOf("</BA_SELECTED_LANGUAGE>", LZ_StartIndex) + 23;
            ...
            Logger.error(LZ_DBCallDetailID, " Exception in RetrieveLanguageSelected Page : " + ex.getMessage(), false);
        }finally{
      
             LZ_MenuOptionList = LZ_MenuCallFlowIDList = LZ_MenuOptionSelected =LZ_LanguageList = LZ_LanguageCallIDList = LZ_DBCallDetailID = null;
        }
