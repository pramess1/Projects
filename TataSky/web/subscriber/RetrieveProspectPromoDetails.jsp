    ...
    public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
     ...
     String LZ_DBCallDetailID = ""; // This is used to store the call detail ID.
        ...
        try {
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveProspectPromoDetails Input ", false);
            if (LZ_SimulatorMode) {
            } else {
            ...
            Logger.info(LZ_DBCallDetailID, " RetrieveProspectPromoDetails Output = LZ_BACallerType : " + LZ_BACallerType + " LZ_BAProspectPromoFlag : " + LZ_BAProspectPromoFlag + " LZ_BAProspectPromoDetailFlag : " + LZ_BAProspectPromoDetailFlag, false);
