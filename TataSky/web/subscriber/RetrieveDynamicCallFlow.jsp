...
//            LZ_DynamicCallFlowXML = state.getString("LZ_DynamicCallFlowXML");
                ...
                System.out.println("LZ_DynamicCallFlowXML" + LZ_DynamicCallFlowXML);

                LZ_CallDetailID = XMLAO.getNodeAttributeText(doc, "CallFlow", "CDID");

                Logger.info(LZ_CallDetailID, " RetrieveDynamicCallFlow Input = LZ_DynamicCallFlowXML : " + LZ_DynamicCallFlowXML, false);
            ...
            Logger.error(LZ_CallDetailID, " Exception in RetrieveDynamicCallFlow Page : " + ex.getMessage(), false);
        } finally {
            Logger.info(LZ_CallDetailID, " RetrieveDynamicCallFlow Output = LZ_PromptList : " + LZ_PromptList + " LZ_MenuList : " + LZ_MenuList + " LZ_MenuOptionList : " + LZ_MenuOptionList
