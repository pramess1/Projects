...
//            LZ_DBCallDetailID = state.getString("LZ_CallDetailID");
            ...
            Logger.info("Get Work Order Details ", " SUBSCRIBER_ID : " + BA_SUBSCRIBER_ID, false);
            ...
            LZ_WO_no = LZ_WO_no.replace("-", "");
             ...
             BA_SUBSCRIBER_ID = LZ_RequestXML = LZ_ResponseXML = LZ_ServiceID = LZ_TransStartTime = LZ_TransEndTime = LZ_errorcode = LZ_errorMsg = null;
