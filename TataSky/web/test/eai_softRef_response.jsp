...
//        String dateTime = Util.getCurrentDateAnyFormat("dd/MM/yyyy hh:mm:ss");
        ...
        Logger.info("SoftHeavyRefreshResponse " , Util.getCurrentDateAnyFormat("dd/MM/YYYY hh:mm:ss"), false);
...
//        Eai ea = new Eai();
//        out.println(ea.softRefresh(Ivr_id,Sbscrbr_id,requst_typ,daatte));
       %>
