...
//                LZ_spUpdateDirectSalesActivityDetails = state.getString("LZ_spUpdateDirectSalesActivityDetails");
                ...
                LZ_PackName = LZ_CallFlowDetailXML.substring(LZ_CallFlowDetailXML.lastIndexOf("<pack_name>") + 11, LZ_CallFlowDetailXML.lastIndexOf("</pack_name>"));               

                LZ_TotalAmount = LZ_CallFlowDetailXML.substring(LZ_CallFlowDetailXML.lastIndexOf("<total_amount>") + 14, LZ_CallFlowDetailXML.lastIndexOf("</total_amount>"));               
...
//                    + " LZ_DBCallDetailID : " + LZ_DBCallDetailID + " LZ_spUpdateDirectSalesActivityDetails : " + LZ_spUpdateDirectSalesActivityDetails, false);
                ...
                CreateActivityResponse objDataService = new CreateActivity().requestCreateActivity(LZ_IVRTxnID,
                        ...
                        LZ_TxnSuccess, LZ_RefNo, LZ_RRN, LZ_APGID, LZ_Amount, LZ_PackName, 
                        LZ_BonusAmount, LZ_HardwareAmount, LZ_PackageAmount, LZ_TotalAmount, LZ_AtomMerchantID, LZ_UserID, LZ_DBCallDetailID);
            ...
            try {
                ...
                if(LZ_errorcode.equalsIgnoreCase("MR") || LZ_errorcode.equalsIgnoreCase("EA")) {
                ...
                String pgTransDetailXml = new GenerateXml().requestUpdateDirectSalesActivityDetails("", "", LZ_ActivityID, LZ_TransEndTime, LZ_errorcode, LZ_errorMsg, LZ_DBCallDetailID);
