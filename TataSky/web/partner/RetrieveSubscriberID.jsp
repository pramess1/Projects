...
//            LZ_InputValue = state.getString("LZ_InputValue");
            ...
            LZ_NoInputCFID = LZ_CallDetailID = LZ_CallFlowID = LZ_CallFlowDateTime = LZ_CallFlowInputStartDateTime = LZ_CallFlowInputEndDateTime = LZ_InputID = LZ_InputValue = LZ_NoOfAttempts = LZ_RuleID = LZ_IsSuccess = LZ_CallFlowFirstInputStartDateTime = LZ_CallFlowFirstInputEndDateTime = LZ_FirstInputID = LZ_FirstInputValue =  LZ_CallFlowSecondInputStartDateTime = LZ_CallFlowSecondInputEndDateTime = LZ_SecondInputID = LZ_SecondInputValue =  LZ_CallFlowThirdInputStartDateTime = LZ_CallFlowThirdInputEndDateTime = LZ_ThirdInputID = LZ_ThirdInputValue = null;
        }
